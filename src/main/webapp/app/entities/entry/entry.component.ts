...
export class EntryComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.entryService
      ...
      .subscribe(
        (res: HttpResponse<IEntry[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IEntry[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
