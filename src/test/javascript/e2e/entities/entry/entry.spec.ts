...
describe('Entry e2e test', () => {
  ...
  it('should load Entries', async () => {
    ...
    expect(await entryComponentsPage.getTitle()).to.eq('blogSpringAngularApp.entry.home.title');
  ...
  it('should load create Entry page', async () => {
    ...
    expect(await entryUpdatePage.getPageTitle()).to.eq('blogSpringAngularApp.entry.home.createOrEditLabel');
  ...
  it('should delete last Entry', async () => {
    ...
    expect(await entryDeleteDialog.getDialogTitle()).to.eq('blogSpringAngularApp.entry.delete.question');
