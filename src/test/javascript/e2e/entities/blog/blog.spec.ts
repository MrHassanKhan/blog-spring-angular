...
describe('Blog e2e test', () => {
  ...
  it('should load Blogs', async () => {
    ...
    expect(await blogComponentsPage.getTitle()).to.eq('blogSpringAngularApp.blog.home.title');
  ...
  it('should load create Blog page', async () => {
    ...
    expect(await blogUpdatePage.getPageTitle()).to.eq('blogSpringAngularApp.blog.home.createOrEditLabel');
  ...
  it('should create and save Blogs', async () => {
    ...
    await promise.all([
      ...
      blogUpdatePage.setDescriptionInput('description'),
    ...
    expect(await blogUpdatePage.getDescriptionInput()).to.eq('description', 'Expected Description value to be equals to description');
  ...
  it('should delete last Blog', async () => {
    ...
    expect(await blogDeleteDialog.getDialogTitle()).to.eq('blogSpringAngularApp.blog.delete.question');
